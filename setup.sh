...
sudo mv ~/.config/wayfire.ini ~/.config/wayfire.ini.bak
cp ~/webcanvasbox/wayfire.ini ~/.config/wayfire.ini
...
sleep 5
sudo cp ~/hideaway/build/hideaway /usr/bin && sudo chmod +x /usr/bin/hideaway
